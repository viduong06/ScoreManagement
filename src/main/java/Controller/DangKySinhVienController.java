 ...
 * @author quochuy
 */
public class DangKySinhVienController implements Initializable {
            ...
            if (tk.matches(regex)) {
                if (!dbLogin.checkTK(tk)) {
                    ...
                    try {
                        ...
                        Parent root1 = FXMLLoader.load(getClass().getResource("/View/MainMenu/loginSinhVienFXML.fxml"));
                    ...
                    lblStatusDangKy.setText("Vui lòng nhập theo định dạng(VD:000@st.huce.edu.vn");
                    lblStatusDangKy.setVisible(true);
                    PauseTransition pause = new PauseTransition(Duration.seconds(3));
                    pause.setOnFinished(b -> lblStatusDangKy.setText(""));
                    pause.play();
