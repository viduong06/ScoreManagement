...
public class SinhVienController implements Initializable {
    ...
    @FXML
    private Button dkyMon;
    @FXML
    private Button xemDanhSachLop;
    @FXML
    ...
    @FXML
    public void ShowDangKyMon(ActionEvent event){
         try {
            AnchorPane pane = FXMLLoader.load(getClass().getResource("/View/MenuSinhVien/DangKyMonFXML.fxml"));
    ...
    @FXML
    public void ShowDanhSachLop(ActionEvent event){
         try {
            AnchorPane pane = FXMLLoader.load(getClass().getResource("/View/MenuSinhVien/danhSachLopFXML.fxml"));
            contentPane.getChildren().setAll(pane);
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        addHover(dkyMon, 10, -5);
        addHover(xemDanhSachLop, 10, -5);
