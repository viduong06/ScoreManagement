 ...
 * @author quochuy
 */
public class dangNhapSinhVienController implements Initializable {
    ...
    @FXML
    public void clickOnDangNhapSinhVien(ActionEvent event){
        String tk = txtTaiKhoan.getText();
        String mk = txtMatKhau.getText();
        if(dbLogin.checkLogin(tk, mk, role)){
            DangNhap.setUsername(mk);
         try {
            Parent root = FXMLLoader.load(getClass().getResource("/View/MenuSinhVien/MainMenuFXML.fxml"));
    ...
    @FXML
    public void clickOnDangKy1(ActionEvent event){
        try{
            Parent root = FXMLLoader.load(getClass().getResource("/View/MainMenu/dangKySinhVienFXML.fxml"));
            Scene scene = new Scene(root);
    ...
    @FXML
    public void clickOnTroVe1(ActionEvent event){
        try{
